 ...
 */
public class PlayerActivity extends FragmentActivity implements SurfaceHolder.Callback,
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (mIsOnTv) {
      ...
      mPlaybackOverlayFragment =
          (PlaybackOverlayFragment) getSupportFragmentManager().findFragmentById(R.id.playback_controls_fragment);
    } else {
