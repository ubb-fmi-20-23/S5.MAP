...
class CustomComplicationProviderService : ComplicationProviderService() {
  ...
  override fun onComplicationActivated(
    ...
    logd("onComplicationActivated(): $complicationId")
  }
  ...
  override fun onComplicationUpdate(
      complicationId: Int, dataType: Int, complicationManager: ComplicationManager) {
    logd("onComplicationUpdate() id: $complicationId")
    ...
    when (dataType) {
      ...
      ComplicationData.TYPE_RANGED_VALUE -> complicationData = ComplicationData.Builder(ComplicationData.TYPE_RANGED_VALUE)
          ...
          .setTapAction(complicationPendingIntent)
          .build()
      else -> logw("Unexpected complication type $dataType")
    }
  ...
  override fun onComplicationDeactivated(complicationId: Int) {
    logd("onComplicationDeactivated(): $complicationId")
  }
}
