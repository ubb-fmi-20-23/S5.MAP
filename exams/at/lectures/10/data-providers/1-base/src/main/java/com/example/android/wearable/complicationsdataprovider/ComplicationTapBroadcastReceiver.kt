...
class ComplicationTapBroadcastReceiver : BroadcastReceiver() {
  ...
  companion object {
    ...
    private const val EXTRA_PROVIDER_COMPONENT = "com.example.android.wearable.watchface.provider.action.PROVIDER_COMPONENT"
    private const val EXTRA_COMPLICATION_ID = "com.example.android.wearable.watchface.provider.action.COMPLICATION_ID"

    internal const val MAX_NUMBER = 20
    internal const val COMPLICATION_PROVIDER_PREFERENCES_FILE_KEY = "com.example.android.wearable.watchface.COMPLICATION_PROVIDER_PREFERENCES_FILE_KEY"
